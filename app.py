...
def daily_tractor_report():
    ...
    print(f"=== DAILY TRACTOR REPORT DEBUG ===")
    print(f"Selected Farmer: {selected_farmer}")
    print(f"Show Full: {show_full}")
    print(f"Rows count: {len(rows)}")
    print(f"Total Amount: {total_amount}")
    print(f"Advance Amount: {advance_amount}")
    print(f"Balance: {calculated_balance}")
    print(f"Paid Records: {paid_records}")
    print(f"Unpaid Records: {unpaid_records}")
    if rows:
...
if __name__ == '__main__':
    ...
    print("  - http://localhost:" + str(port) + "/diesel/add (Add Diesel Purchase - with History)")
